...
Para inicar un Set, se debe crear una instancia de su clase a partir 
de un iterable. Generalmente, un iteable es un array.
...
- delete(value): elimina un elemento que contiene el Set, retorna un 
booleano si existía o no el valor.
